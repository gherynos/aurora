    ...
    public DBUtils(String confFolder, String password) throws AuroraException {
        ...
        try (var conn = getConnection();
            ...
            if (rs.next()) {
                ...
                st.execute("CREATE TABLE OUTGOING_FILES (FILE_ID VARCHAR, PATH VARCHAR, IDENTIFIER VARCHAR, TOTAL_PARTS INT, CONSTRAINT PK_OF PRIMARY KEY(FILE_ID, IDENTIFIER), CONSTRAINT FK_IDENTIFIER FOREIGN KEY(IDENTIFIER) REFERENCES PUBLIC_KEYS(IDENTIFIER));");
                ...
                st.execute("CREATE TABLE INCOMING_FILES (FILE_ID VARCHAR, PATH VARCHAR, IDENTIFIER VARCHAR, TOTAL_PARTS INT, COMPLETE BOOL, CONSTRAINT PK_IF PRIMARY KEY (FILE_ID, IDENTIFIER), CONSTRAINT FK_INC_IDENTIFIER FOREIGN KEY(IDENTIFIER) REFERENCES PUBLIC_KEYS(IDENTIFIER));");
